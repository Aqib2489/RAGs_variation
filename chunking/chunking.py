...
print(f"Loaded {len(documents)} pages frompdf")

num_eval_questions = 10  # Reduced from 25 for faster testing

eval_documents = documents  # Use all pages
...
print("\n" + "="*80)
print("CHUNK SIZE EVALUATION ON RESUME.PDF")
print("="*80)
